...
export const DEFAULT_PRICING_CONFIG: PricingConfig = {
  services: [
    ...
    },
    {
      id: "winch_out",
      name: "Winch Out",
      description: "Vehicle stuck in ditch/mud/snow",
      basePrice: 8500,
      pricePerMile: 300,
      minimumMiles: 0,
      freeIncludedMiles: 0,
  ...
  discounts: {
    promoCodeDiscounts: {
      FIRST10: {
        type: "percent", value: 10, maxDiscount: 2000,
        minOrderValue: 5000, expiresAt: "2026-12-31", maxUses: 10000, currentUses: 0,
      },
      SAVE20: {
        type: "fixed", value: 2000, minOrderValue: 7500, expiresAt: "2026-06-30",
      },
      HERO50: {
        type: "percent", value: 50, maxDiscount: 5000,
        applicableServices: ["dead_battery", "flat_tire"],
      },
    },
    membershipDiscounts: {
