...
/// Hero menu as a bottom sheet that slides up from the bottom.
class HeroDrawer extends ConsumerWidget {
  const HeroDrawer({super.key});

  /// Call this from the hamburger button instead of Scaffold.openDrawer().
  static void show(BuildContext context) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => const HeroDrawer(),
    );
  }
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: const Icon(Icons.exit_to_app, color: Color(0xFFE53935), size: 20),
                                ),
                                ...
                                const Icon(Icons.chevron_right, color: Color(0xFFE53935), size: 24),
                              ],
                            ),
                          ),
                        ),
